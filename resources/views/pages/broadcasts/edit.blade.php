                                ...
                                <form action="{{ route('broadcasts.update', $broadcast->id) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        @if($broadcast->file_path)
                                            <div class="file-preview mb-3">
                                                ...
                                                <div class="file-preview-info">
                                                    <div class="file-preview-name">{{ $broadcast->file_name }}</div>
                                                    <div class="file-preview-size">
                                                        <a href="{{ Storage::url($broadcast->file_path) }}" target="_blank" class="text-primary">
                                                ...
                                                <div class="custom-control custom-checkbox ml-3">
                                                    ...
                                                    <label class="custom-control-label" for="remove_file">Remove</label>
                                                </div>
                                            </div>
                                        @endif
                                        ...
                                        <div class="file-upload-wrapper">
                                            ...
                                            <div class="file-upload-message">
                                                ...
                                                <div class="file-upload-text">
                                                    <strong>Click to upload new file</strong> or drag and drop<br>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input" id="send_to_all" name="send_to_all" value="1"
                                                {{ old('send_to_all', $broadcast->send_to_all) ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group">
                                        <div class="custom-control custom-checkbox">
                                            ...
                                            <div class="text-muted small">If unchecked, broadcast will remain as draft</div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group text-right">
                                        ...
                                        <button type="submit" class="btn btn-primary">
                                            <i class="fas fa-save mr-1"></i> Update Broadcast
                                        </button>
                                    </div>
                                </form>
                            </div>
        ...
        $(document).ready(function() {
            ...
            $('#file').on('change', function(e) {
                ...
                if (file) {
                    ...
                    // Uncheck remove file if checked
            ...
            $('#remove_file').on('change', function() {
                if ($(this).is(':checked')) {
                    $('#file').val('');
                    $('.file-preview:not(:first)').hide();
                }
            });
        });
    </script>
